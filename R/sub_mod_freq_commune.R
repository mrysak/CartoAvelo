#' frequentation_commune UI Function
#'
...
mod_frequentation_commune_ui <- function(id, current_year){
  ns <- NS(id)
  tagList(
    br(),
...
#'
#' @noRd
mod_frequentation_commune_server <- function(id, validated_selection, current_year, admin_cache) {
  moduleServer(
    id,
...
# mod_frequentation_commune_ui("frequentation_commune_1")
